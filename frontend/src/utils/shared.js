...
const NavigationItems = [
  {
    ...
    access: [Role.Admin,Role.Category,Role.Buyer, Role.Seller],
  },
  {
    name: "Categories",
  ...
  },
  {
    ...
    access: [Role.Admin, Role.Seller,Role.Category,Role.Buyer, Role.Seller],
  },
  {
    name: "Update Profile",
    route: RoutePaths.UpdateProfile,
    access: [Role.Admin, Role.Buyer, Role.Seller,Role.Category],
  },
];
